...
def print_info() -> None:
    ...
    白色 art + 灰色副标题/分隔线 + 蓝色版本与许可证行，配色对齐
    pixi_alas_install.sh。colorama 已在控制台日志格式化器中初始化，
    此处直接使用颜色常量。
    """
    colorama.init(autoreset=True)
    print()
    print(colorama.Fore.WHITE + _BANNER_ART + colorama.Style.RESET_ALL)
    print()
    print(colorama.Fore.LIGHTBLACK_EX + _BANNER_SUBTITLE + colorama.Style.RESET_ALL)
